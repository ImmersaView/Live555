...
class LIVE_API RTSPServer: public GenericMediaServer {
public:
...
public: // should be protected, but some old compilers complain otherwise
  ...
  class LIVE_API RTSPClientConnection: public GenericMediaServer::ClientConnection {
  public:
  ...
  class LIVE_API RTSPClientSession: public GenericMediaServer::ClientSession {
  protected:
