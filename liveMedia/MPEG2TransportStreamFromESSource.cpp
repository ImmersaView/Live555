...
// START IMMERSAVIEW EDIT
// Was getting 'input buffer too small' error messages, so we need to increase the size of this buffer. Simply doubled it for now.
#define MAX_INPUT_ES_FRAME_SIZE 200000
// END IMMERSAVIEW EDIT
