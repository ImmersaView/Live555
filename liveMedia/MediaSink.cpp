...
#endif
    LIVELOG_WARN("[Live:OutPacketBufferEnqueue],Buffer is full,droppedBytes,%d,required,%d,available,%d",
        numBytes - totalBytesAvailable(), numBytes, totalBytesAvailable());
    numBytes = totalBytesAvailable();
  }
