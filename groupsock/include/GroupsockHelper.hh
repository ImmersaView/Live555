...
// IMV - Exposed send/recv interface over DLL boundary
LIVE_API void SetSendingInterfaceAddr(const char* ipString);
LIVE_API void SetReceivingInterfaceAddr(const char* ipString);
...
LIVE_API extern int gettimeofday(struct timeval*, int*);
#endif
